				...
				<div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8 relative z-10">
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
						...
						<div className="footer-social-section">
							...
							<div className="grid grid-cols-4 gap-3 footer-social-icons">
								{/* Instagram */}
								<a
									...
									className="social-icon group relative p-3 bg-gray-800/50 backdrop-blur rounded-xl border border-gray-700/50 hover:border-pink-500/50 transition-all duration-300 hover:scale-110 hover:bg-gradient-to-br hover:from-purple-600 hover:to-pink-500">
									<svg
								...
								<a
									...
									rel="noopener noreferrer"
									aria-label="TikTok"
									className="social-icon group relative p-3 bg-gray-800/50 backdrop-blur rounded-xl border border-gray-700/50 hover:border-red-500/50 transition-all duration-300 hover:scale-110 hover:bg-gradient-to-br hover:from-red-500 hover:to-pink-500">
									<svg
										xmlns="http://www.w3.org/2000/svg"
										width="20"
										height="20"
										...
										fill="currentColor"
										className="transition-colors duration-300 group-hover:text-white">
										<path d="M19.321 5.562a5.124 5.124 0 0 1-.443-.258 6.228 6.228 0 0 1-1.137-.966c-.849-.849-1.166-1.618-1.166-2.419V1.6h-3.064v14.82c0 2.24-1.821 4.06-4.06 4.06-2.24 0-4.061-1.82-4.061-4.06s1.821-4.061 4.06-4.061c.425 0 .832.065 1.215.186v-3.13c-.392-.055-.794-.084-1.205-.084C4.93 9.33 1 13.26 1 18.04S4.93 26.75 9.71 26.75s8.71-3.93 8.71-8.71V7.864c1.196.695 2.61 1.098 4.125 1.098V5.898c-.825 0-1.606-.173-2.224-.336z" />
									</svg>
								</a>
								...
								<a
									...
									className="social-icon group relative p-3 bg-gray-800/50 backdrop-blur rounded-xl border border-gray-700/50 hover:border-blue-500/50 transition-all duration-300 hover:scale-110 hover:bg-gradient-to-br hover:from-blue-600 hover:to-blue-400">
									<svg
										xmlns="http://www.w3.org/2000/svg"
										width="20"
										height="20"
								...
								<a
									...
									rel="noopener noreferrer"
									aria-label="Facebook"
									className="social-icon group relative p-3 bg-gray-800/50 backdrop-blur rounded-xl border border-gray-700/50 hover:border-blue-600/50 transition-all duration-300 hover:scale-110 hover:bg-gradient-to-br hover:from-blue-700 hover:to-blue-500">
									<svg
										xmlns="http://www.w3.org/2000/svg"
										width="20"
										height="20"
								...
								<a
									...
									rel="noopener noreferrer"
									aria-label="YouTube"
									className="social-icon group relative p-3 bg-gray-800/50 backdrop-blur rounded-xl border border-gray-700/50 hover:border-red-600/50 transition-all duration-300 hover:scale-110 hover:bg-gradient-to-br hover:from-red-600 hover:to-red-500">
									<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24" className="transition-colors duration-300 group-hover:text-white">
								...
								<a
									...
									className="social-icon group relative p-3 bg-gray-800/50 backdrop-blur rounded-xl border border-gray-700/50 hover:border-green-500/50 transition-all duration-300 hover:scale-110 hover:bg-gradient-to-br hover:from-green-600 hover:to-green-500">
									<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="transition-colors duration-300 group-hover:text-white">
								...
								<a
									...
									className="social-icon group relative p-3 bg-gray-800/50 backdrop-blur rounded-xl border border-gray-700/50 hover:border-blue-500/50 transition-all duration-300 hover:scale-110 hover:bg-gradient-to-br hover:from-blue-500 hover:to-blue-400">
									<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24" className="transition-colors duration-300 group-hover:text-white">
								...
								<a
									...
									rel="noopener noreferrer"
									aria-label="Linktree"
									className="social-icon group relative p-3 bg-gray-800/50 backdrop-blur rounded-xl border border-gray-700/50 hover:border-green-400/50 transition-all duration-300 hover:scale-110 hover:bg-gradient-to-br hover:from-green-500 hover:to-green-400">
									<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24" className="transition-colors duration-300 group-hover:text-white">
