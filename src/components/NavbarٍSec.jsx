...
function Navbar({ changeLanguage }) {
	...
	return (
		<nav
			...
			<div className="navbar bg-base-100 px-4 sm:px-8 py-3 border-b border-gray-200 shadow-sm">
				{/* الجزء الأيسر: عربة التسوق */}
				{/* cart */}
			...
			{/* الجزء الأوسط: الروابط والشعار (للشاشات الكبيرة) */}
