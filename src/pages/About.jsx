		...
		<div
			...
			<section
				...
				<div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div
						className={`bg-white rounded-xl shadow-lg p-8 transition-all duration-1000 ${isVisible["testimonial-section"]
			...
			<section
				...
				<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					<h2
						className={`text-3xl md:text-4xl font-bold mb-4 transition-all duration-1000 ${isVisible["cta-section"]
							? "opacity-100 translate-y-0"
							: "opacity-0 translate-y-10"
							}`}>
						{t("about.cta.title")}
					...
					<p
						className={`text-lg mb-8 transition-all duration-1000 delay-200 ${isVisible["cta-section"]
							? "opacity-100 translate-y-0"
							: "opacity-0 translate-y-10"
							}`}>
